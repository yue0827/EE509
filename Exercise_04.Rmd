...
plot(dseq,a0*dseq^2,type = 'l',col=1,xlab='dia',ylab = 'Fecundity',main = "dia vs ncone")  ## add fecundity relationship
lines(dseq,a0*dseq^2*pnorm(dseq,b0,b1),col=2)
legend('topleft',lty=1,legend = c('g(x)','g(x)theta(x)'),col = c(1,2))
plot(dseq,pnorm(dseq,b0,b1),col=2,type='l',xlab='dia',ylab = 'Maturation',main = 'dia vs cones') 
